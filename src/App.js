    ...
    <BrowserRouter>
      <div className="App">
        ...
        <div className='content'>
          ...
          <Route exact path='admin/edit-room/:roomId' element={<ProtectedRoute element={<EditRoomPage/>}/>} />
          <Route exact path='admin/edit-booking/:bookingCode' element={<ProtectedRoute element={<EditBookingPage/>}/>} />
